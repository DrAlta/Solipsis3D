...
#ifndef __Panel2DHybridcom_h__
#define __Panel2DHybridcom_h__
...
/** This class manages 2D panel for Hybridcom material.
*/
class Panel2DHybridcom : public Panel2D
{
protected:
...
public:
    /// Constructor
    Panel2DHybridcom(const Ogre::String& type, const Ogre::String& name);
    /// Destructor
    ~Panel2DHybridcom();
...
/** This factory class to create 2D panel for Hybridcom material.
*/
class Panel2DHybridcomFactory : public Panel2DFactory
{
private:
    /// Panel2D type
...
public:
    ...
    {
        return new Panel2DHybridcom(ms_Type, name);
    }
...
#endif // #ifndef __Panel2DHybridcom_h__
