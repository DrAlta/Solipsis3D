...
if exist "%dst%\Plugin_OctreeZone.dll" goto Plugin_OctreeZone_exist
 ...
 if exist "%OGRE_HOME%\bin\release\Plugin_OctreeZone.dll" xcopy "%OGRE_HOME%\bin\release\Plugin_OctreeZone.dll" "%dst%" /s /y
...
if exist "%dst%\Plugin_PCZSceneManager.dll" goto Plugin_PCZSceneManager_exist
 ...
 if exist "%OGRE_HOME%\bin\release\Plugin_PCZSceneManager.dll" xcopy "%OGRE_HOME%\bin\release\Plugin_PCZSceneManager.dll" "%dst%" /s /y
