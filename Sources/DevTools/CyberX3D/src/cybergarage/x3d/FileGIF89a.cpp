...
{
	if (image[n].localColorTable) {
		color[cR] = image[n].localColorTable[index][cR];
		color[cG] = image[n].localColorTable[index][cG];
		color[cB] = image[n].localColorTable[index][cB];
	}
	else if (globalColorTable) {
		color[cR] = globalColorTable[index][cR];
		color[cG] = globalColorTable[index][cG];
		color[cB] = globalColorTable[index][cB];
	}
}
