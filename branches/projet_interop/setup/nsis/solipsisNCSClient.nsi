...
!define PRODUCT_NAME "Solipsis Client"
...
Section "Media" SEC02
  ...
  File /r /x .svn /x NaviLocal /x lua /x cacheServer* /x Declarativemodeling /x *.xml /x *.ssf "..\..\Media\*.*"
  File /oname=cache\cache_ref.xml "..\..\Media\cache\cache_NoScene_ref.xml"
  File /oname=cache\cache.xml "..\..\Media\cache\cache_NoScene_ref.xml"
