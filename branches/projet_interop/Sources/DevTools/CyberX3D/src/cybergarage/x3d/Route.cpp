...
//Route::Route(RouteNode * rNode, SceneGraph * sg){
//
//	SFString fNodeS = rNode->getFromNode();
//	SFString fFieldS = rNode->getFromField();
//	SFString toNodeS = rNode->getToNode();
//	SFString toFieldS = rNode->getToField();
//
//	Node * fromNode = sg->findNode(rNode->getFromNode());
//	Field * fromField = fNode->findField(rNode->getFromField());
//
//	Node * toNode = sg->findNode(rNode->getToNode());
//	Field * toField = fNode->findField(rNode->getToField());
//
//	setHeaderFlag(false);
//	setEventOutNode(toNode);
//	setEventInNode(fromNode);
//	setEventOutField(toField);
//	setEventInField(fromField);
//	initialize();
//
//}
